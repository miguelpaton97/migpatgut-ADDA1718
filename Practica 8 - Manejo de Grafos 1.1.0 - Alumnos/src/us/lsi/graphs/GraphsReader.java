...
public class GraphsReader {
	 ...
	 * @param vf Factor�a para construir los vértices a partir de las líneas del fichero previamente tokenizada
	 * @param ef Factor�a para construir las aristas a partir de las líneas del fichero previamente tokenizada
